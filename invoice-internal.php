						...
						<tr>
							<td style="padding-right: 32px; width: 478px;">
								<table>
									...
									<tr>
										<td style="margin-bottom: 12px; padding-bottom: 16px;">
											<p style="font-size: 10px; margin-bottom: 4px;">Deadline Pengiriman :</p>
		...
		<table width="100%" style="background-color: #e4e4e4;">
			<tr>
				<td colspan="3">
					...
					<table border="1">
						<tr>
							<td style="background: #FFF; padding: 6px; width: 148px;">
								<p style="font-size: 10px; margin-bottom: 2px;">Admin Web :</p>
								<p>ANIS</p>
							</td>
							<td style="background: #FFF; padding: 6px; width: 148px;">
								<p style="font-size: 10px; margin-bottom: 2px;">Finance :</p>
								<p>IDA</p>
							</td>
							<td style="background: #FFF; padding: 6px; width: 148px;">
								<p style="font-size: 10px; margin-bottom: 2px;">Admin Gudang :</p>
								<p>SRI</p>
							</td>
						</tr>
					</table>
